...
<style>
    body {
        background-image: url("../assets/imgs/fundo-carteirinha.png");
        ...
        <div class="row">
            ...
            <div class="col-md-4 retorno">
                <form class="form-signin" method="POST" action="../data/login.php">
                    <img style="border-radius: 12px;" class="mb-4" src="../assets/imgs/logo-vsss.png" alt="" width="200">

                    <h1 class="h3 mb-3 font-weight-normal">Login Arquivo Central</h1>
